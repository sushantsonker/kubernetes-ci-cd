...
# docker build -t 3.15.10.124:30400/kubescale:$TAG -f 

# # echo "building set image"

# cd set; docker build -t 3.15.10.124:30400/set:$TAG -f set/Dockerfile .
...
# docker push 3.15.10.124:30400/kubescale:latest
# docker push 3.15.10.124:30400/set:latest
