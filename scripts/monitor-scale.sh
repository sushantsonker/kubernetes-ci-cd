...
docker build -t 3.15.10.124:30400/monitor-scale:$BUILD_TAG -f applications/monitor-scale/Dockerfile applications/monitor-scale
...
#Push the images
docker push 3.15.10.124:30400/monitor-scale:$BUILD_TAG
...
sed 's#3.15.10.124:30400/monitor-scale:$BUILD_TAG#3.15.10.124:30400/monitor-scale:'$BUILD_TAG'#' applications/monitor-scale/k8s/deployment.yaml | kubectl apply -f -
